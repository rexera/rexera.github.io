...
What I'm truly after is to build **native capabilities into the model to handle long contexts** with minimal performance degradation, to reproduce the scaling law in contexts, and to implement all of this in various configurations and real-world scenarios. 
